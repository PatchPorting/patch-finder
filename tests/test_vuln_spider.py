...
class TestVulnSpider(unittest.TestCase):
    ...
    def setUp(self):
        ...
        vuln = context.UnparsableVulnerability(
            "dummy_vuln", None, "https://example.com", None
        )
    ...
    def test_parse_html(self):
        ...
        self.spider.vuln.parse_mode = "html"
        self.spider.vuln.xpaths = [
            "//div[contains(@class, 'references')]" "//ul//li/text()"
        ]
    ...
    def test_parse_plain_as_per_block(
        ...
        self.assertEqual(item["equivalent_vulns"], equivalent_vulns)
